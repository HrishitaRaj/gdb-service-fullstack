...
public class AadharClient {
    ...
    public boolean verifyAadhar(String aadharNumber) {
        ...
        try {
            ...
            log.error("Aadhar validation failed: {}", e.getResponseBodyAsString());
    ...
    private boolean verifyAadharFallback(String aadharNumber, Exception e) {

        log.error("Aadhar verification failed after retries: {}", e.getMessage());

        throw new RuntimeException(
            "Aadhar verification service is temporarily unavailable. Please try again later.");
    }
